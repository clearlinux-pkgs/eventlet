...
%prep
%setup -q -n eventlet-0.25.2
cd %{_builddir}/eventlet-0.25.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588200519
...
cp %{_builddir}/eventlet-0.25.2/LICENSE %{buildroot}/usr/share/package-licenses/eventlet/ad33faded4baaba18a31704973874c531e94d910
